                ...
                <div class="card mb-4 shadow-sm">
                    <div class="card-body"><img src="{{ asset('storage/' . $advertentie->afbeelding_path) }}" class="card-img-top" alt="{{ $advertentie->titel }}" style="height: 225px; width: 100%; display: block;">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <a href="{{ route('advertenties.show', $advertentie) }}" class="btn btn-sm btn-outline-secondary">Bekijk</a>
                                <a href="{{ route('advertenties.edit', $advertentie) }}" class="btn btn-sm btn-outline-secondary">Bewerk</a>
                            </div>
