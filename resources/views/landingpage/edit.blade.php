        ...
        <div class="flex flex-wrap">
            <div id="menu" class="w-full lg:w-1/2 p-4">
                <form action="{{ route('landingpage-settings.update', $pageSetting->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="text_style_font" class="block text-gray-700 text-sm font-bold mb-2">Lettertype
                            (Font):</label>
                        ...
                        <label for="text_style_size"
                            class="block text-gray-700 text-sm font-bold mb-2 mt-4">Lettergrootte (Size):</label>
                    ...
                    <div class="mb-4">
                        ...
                        <div>
                            ...
                            <label for="components_intro" class="text-gray-700 text-sm font-bold">Introductie</label>
                            <div id="intro_details"
                                style="{{ isset($components['intro']['intro']) ? '' : 'display:none;' }}">
                                <textarea name="intro[text]" id="intro_text"
